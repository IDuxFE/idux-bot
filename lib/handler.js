        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, addIssueLabels(context)];
                case 3:
                    _a.sent();
...
function addIssueLabels(context) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, title, number, titleMathResult, title_1, _b, module_1, _c, name, labels, e_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _a = context.payload.issue, title = _a.title, number = _a.number;
                    titleMathResult = title.match(/\[(.*)\]/);
...
function translateIssue(context, config) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, mark, replay, _b, body, title, number, translateOptions, translatedTitle, translatedBody, content, comment, e_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, google_translate_api_1.default(body.replace(/<!--(.*?)-->/g, ''), translateOptions)];
                case 2:
                    translatedBody = _c.sent();
                    if (!(translatedTitle.text && translatedBody.text)) return [3 /*break*/, 6];
                    content = utils_1.format(replay, { title: translatedTitle.text, body: translatedBody.text });
...
function assignOwner(context, config) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var _b, cdk, comp, pro, def, label, _c, packageName, _d, componentName, targetPackage, assigner, number, e_5;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _b = config.issue.owner, cdk = _b.cdk, comp = _b.comp, pro = _b.pro, def = _b.def;
                    label = context.payload.label.name;
                    _c = label.split(':'), packageName = _c[0], _d = _c[1], componentName = _d === void 0 ? '' : _d;
                    targetPackage = { def: def };
                    if (packageName === 'Cdk') {
                        targetPackage = cdk;
                    }
