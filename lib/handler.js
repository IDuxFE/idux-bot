...
function translateIssue(context, config) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, mark, replay, _b, body, title, number, translateOptions, translatedTitle, placeholder, codeBlock_1, translatedBody, bodyText, content, comment, e_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 1:
                    ...
                    codeBlock_1 = body.match(/```(.*?)```/g);
                    return [4 /*yield*/, google_translate_api_1.default(body.replace(/```(.*?)```/g, placeholder).replace(/<!--(.*?)-->/g, ''), translateOptions)];
                case 2:
                    translatedBody = _c.sent();
                    if (!(translatedTitle.text && translatedBody.text)) return [3 /*break*/, 6];
                    bodyText = translatedBody.text;
                    if (codeBlock_1) {
                        bodyText.replaceAll(placeholder, function () { return codeBlock_1.shift(); });
                    }
                    content = utils_1.format(replay, { title: translatedTitle.text, body: bodyText });
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    assigner = targetPackage[componentName];
                    if (!assigner) {
                        return [2 /*return*/];
                    }
